...
PARAMETER x0_new(r,g,*);
SET temp / "changinv", "not_changinv", "x0", "m0" /;

x0_new(r,g,"changinv") = fd_0("2017",g,"changinv") * region_shr("2017",r,g);
x0_new(r,g,"not_changinv") = i0_("2017",r,g) - x0_new(r,g,"changinv");
x0_new(r,g,"x0") = x0_("2017",r,g);
x0_new(r,g,"m0") = m0_("2017",r,g);

x0_new(r,g,temp)$(x0_new(r,g,"changinv") gt 0) = 0;
